  ...
  return (
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Notifiche Interne</h2>
          <p className="text-gray-600 text-sm mt-1">Ricevi notifiche push e avvisi in tempo reale</p>
        </div>
        <motion.button
        ...
        >
          <Plus size={18} /> Nuova Notifica
        </motion.button>
      </div>

      {notifications.length === 0 ? (
        <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
          <h3 className="text-lg font-semibold text-gray-700">Nessuna notifica configurata</h3>
