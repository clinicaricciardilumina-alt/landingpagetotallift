...
export default function PostBookingActions() {
  ...
  return (
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Post-Booking Actions</h2>
          <p className="text-gray-600 text-sm mt-1">Configura azioni da eseguire dopo una prenotazione</p>
        </div>
        <motion.button
